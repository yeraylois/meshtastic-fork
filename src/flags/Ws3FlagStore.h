...
public:
  ...
  // STATIC INFO
  static constexpr const char *ns() { return WS3_FLAG_NVS_NAMESPACE; }
  static constexpr const char *key() { return WS3_FLAG_NVS_KEY; }
  static constexpr uint32_t def() { return (uint32_t)WS3_FLAG_DEFAULT; }
