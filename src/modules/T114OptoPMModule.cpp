...
T114OptoPMModule::T114OptoPMModule()
  : SinglePortModule("opto_pm", kPort)
  , concurrency::OSThread("opto_pm")
{
...
void T114OptoPMModule::initOnce() {
  ...
  T114_OPTO_PM_LOGI("▶ Monitoring power via PC817 (pin=%d, led=%d, pullup=%u, deb=%u)\n",
                   (int)T114_OPTO_PM_PIN, (int)T114_OPTO_PM_LED, (unsigned)T114_OPTO_PM_PULLUP, (unsigned)T114_OPTO_PM_DEBOUNCE_MS);
