 ...
 * W2S: WEST->SOUTH */
enum : uint8_t {
  VM_S2N = 0, VM_S2W, VM_N2S, VM_N2W, VM_W2N, VM_W2S, VM_COUNT
};
 ...
 * PX_W1 */
enum : uint8_t {
  PX_N1 = 0, PX_S1, PX_W2, PX_S2, PX_N2, PX_W1, PX_COUNT
};
...
enum LightState : uint8_t {
  L_RED = 0, L_GREEN, L_AMBER_FIXED, L_AMBER_FLASH
};

/* ===============================[ MAIN CLASS ]================================ */
class TrafficRs485CoordinatorModule final
